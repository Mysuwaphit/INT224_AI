 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "\n",
    "# Predict the target performance for the user inputs\n",
    "user_input = np.array([hours_studied, previous_scores, sleep_hours]).reshape(1, -1)\n",
    "prediction = model.predict(user_input)\n",
    "\n",
    "st.write('### Prediction')\n",
    "st.write(f'Target Performance: {prediction[0]:.2f}')\n",
    "\n",
